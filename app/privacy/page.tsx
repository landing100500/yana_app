      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            и защиты персональных данных пользователей сервиса {LEGAL_ENTITY.siteName} — интерактивной
            цифровой платформы в области ведической астрологии, самопознания и информационно-образовательных
            материалов.
          </p>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>сведения об оплате тарифов (статус платежа, сумма, идентификатор транзакции).</li>
          </ul>
          <p className={styles.text}>
            Данные банковской карты обрабатываются платёжным сервисом ЮKassa и нам не передаются.
          </p>
          <p className={styles.text}>
            Пользователь не обязан предоставлять сведения о состоянии здоровья, политических взглядах,
            религиозных убеждениях и иных специальных категориях персональных данных.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              предоставления пользователю доступа к информационно-образовательным материалам и инструментам
              анализа в области ведической астрологии и самопознания;
            </li>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            В работе сервиса могут использоваться автоматизированные технологии обработки информации
            и облачные технические решения, необходимые для функционирования платформы и предоставления
            пользователям персонализированных информационных материалов.
          </p>
          <p className={styles.text}>
