      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            цифровому помощнику на базе искусственного интеллекта, включая чат, функции натальной карты
            и иные возможности в соответствии с выбранным тарифом.
          </p>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            Сервис носит информационно-консультационный характер. Ответы и рекомендации,
            формируемые с помощью ИИ, не являются медицинской, юридической или иной профессиональной
            консультацией. Пользователь самостоятельно принимает решения на основе полученной информации.
          </p>
          <p className={styles.text}>
