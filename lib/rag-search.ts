 ...
 * **Безопасно при отсутствии раздела:** возвращает `[]`, если раздела нет в БД, он не `enabled_for_agent`, нет чанков или ошибка эмбеддинга/RPC — вызывающий код не должен падать.
 */
